...
insert into employee (id, first_name, last_name, email) values (1, 'Abhishek', 'Jangid', 'jangid@gmail.com');
insert into employee (id, first_name, last_name, email) values (2, 'Akshay', 'Kumar', 'fake@gmail.com');
insert into employee (id, first_name, last_name, email) values (3, 'Raj', 'Sharma', 'greatlearners@gmail.com');
